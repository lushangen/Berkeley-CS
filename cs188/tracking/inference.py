...
class InferenceModule:
    ...
    def getObservationProb(self, noisyDistance, pacmanPosition, ghostPosition, jailPosition):
        ...
        """
        "*** YOUR CODE HERE ***"
        #ghost = jail and dist = none occurs always
        #ghost = jail but dist != none occurs never
        #ghost != jail but dist = none occurs never
...
class ExactInference(InferenceModule):
    ...
    def observeUpdate(self, observation, gameState):
        ...
        for ghost in self.allPositions:
            ...
            self.beliefs[ghost] = self.beliefs[ghost] * prob
    ...
    def elapseTime(self, gameState):
        ...
        for oldPos in self.allPositions:
            ...
            for newPos in newPosDist.keys():
                newDist[newPos] += self.beliefs[oldPos] * newPosDist[newPos]
...
class ParticleFilter(InferenceModule):
    ...
    def observeUpdate(self, observation, gameState):
        ...
        for particle in self.particles:
            newDist[particle] += self.getObservationProb(observation, pacman, particle, jail)
    ...
    def observeUpdate(self, observation, gameState):
        ...
        for particle in self.particles:
            ...
            for i in range(self.numGhosts):
                ...
                prob *= self.getObservationProb(observation[i], pacman, particle[i], jail)
