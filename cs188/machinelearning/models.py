    ...
    def train(self, dataset):
        ...
        while loss > 0.01:
            for x, y in dataset.iterate_once(self.batch_size):
                ...
                gradient = nn.gradients(self.get_loss(x, y), self.parameters)
                for i in range(len(self.parameters)):
                    self.parameters[i].update(gradient[i], -self.learningRate)
...
class DigitClassificationModel(object):
    ...
    def run(self, x):
        ...
        outputLayer = nn.AddBias(nn.Linear(secondLayer, self.W3), self.b3)
        return outputLayer
...
class LanguageIDModel(object):
    ...
    def __init__(self):
        ...
        self.parameters = [self.W, self.WHidden, self.outputW]
