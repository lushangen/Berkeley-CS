...
public class TestClorus {
    ...
    public void testReplicate() {
        ...
        Clorus baby = clorus.replicate();
        assertEquals(clorus.energy(), .5, .01);
        assertEquals(baby.energy(), .5, .01);
    }
    ...
    public void testChoose() {
        ...
        HashMap<Direction, Occupant> rushb = new HashMap<Direction, Occupant>();
        surrounded.put(Direction.TOP, new Impassible());
        surrounded.put(Direction.BOTTOM, new Impassible());
        surrounded.put(Direction.LEFT, new Impassible());
        surrounded.put(Direction.RIGHT, plip);

        expected = new Action(Action.ActionType.ATTACK, Direction.RIGHT);
        actual = p.chooseAction(rushb);
